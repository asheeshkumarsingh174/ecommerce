...
<body>
                        <div class="lat">
	                    <div class="rat" style="padding-top:15px">
	                    <form autocomplete="off" action="index.php" method="POST">
                        <div class="autocomplete" style="width:300px;">
                        <input id="myInput" type="text" name="product" placeholder="Search for products">
                        </div>
...
?>
<script> window.location="blank.php?kid=<?php echo $product;?>"; </script>
<?php
}
...
var countries = ["acer","samsung","dell"];
										...
										<div class="cart-list">
											...
											<div class="product-widget">
												<div class="product-img">
													<img src="./img/<?php echo $z['pimage']?>.png" alt="">
												</div>
												<div class="product-body">
													<h3 class="product-name"><a href="#"><?php echo $z['name']; ?></a></h3>
													<h4 class="product-price"><span class="qty"></span><?php echo $z['price'];?></h4>
												</div>
												<form action="index.php" method="POST">
												<button value="<?php echo $z['id'];?>" name="<?php echo $z['id'];?>" class="delete"><i class="fa fa-close"></i></button>
											</form>
											</div>
											<?php
											 ...
											 if(isset($_POST[$z['id']])){
												...
												<input type="hidden" value="<?php echo $r; ?>" name="delete">
												</form>
												<?php
...
$qry="SELECT * FROM `products` WHERE `rating`>=4  ";
